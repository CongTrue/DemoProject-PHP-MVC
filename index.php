...
<style>
    #menu span { display:inline-block; height:30px;color: #FFF; padding-top:7px}
    .admin {width:10%; float:right;text-align:right; padding-right:5px}
    .admin a{color:#FF0; text-decoration:none;}
</style>
